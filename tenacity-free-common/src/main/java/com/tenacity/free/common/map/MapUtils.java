package com.tenacity.free.common.map;
...
import com.tenacity.free.common.string.StringUtils;
...
public class MapUtils {
	...
	/**
	 * @author: free.zhang
	 * @datetime: 2018年1月13日 下午6:39:20
	 * @desc: 判断Map中是否存在某个Key
	 * @param map
	 * @param key
	 * @return
	 */
	...
	/**
	 * @author: free.zhang
	 * @datetime: 2018年1月13日 下午6:39:33
	 * @desc: 根据Key获取Value，非map.get()方法，而是去遍历，通过KEY忽略大小写来比较，如果相等，则返回value
	 * @param map
	 * @param key
	 * @return
	 */
	...
	public static <T> void mapToEntity(Map map, T t, boolean ignore)

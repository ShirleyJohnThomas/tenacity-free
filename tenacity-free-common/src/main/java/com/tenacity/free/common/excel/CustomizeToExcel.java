package com.tenacity.free.common.excel;

import com.google.gson.JsonArray;
import com.google.gson.JsonElement;
import com.google.gson.JsonParser;
import com.tenacity.free.common.random.RandomUtils;
 ...
 * @file_name: CustomizeToExcel.java
 * @author: free.zhang
 * @datetime: 2018年1月13日 下午8:14:49
 * @desc: 自定义表头导出Excel
 */
public class CustomizeToExcel {
     ...
     * @throws Exception
     * @author: free.zhang
     * @datetime: 2018年1月13日 下午8:20:11
     * @desc: 写入到文件
     */
    public static void toFile(List<ExcelColumn> columns, List<Map<String, Object>> list, String filePath)
            throws Exception {
        GsonTools gt = new GsonTools(false, null, null, null);
    ...
    /**
     * @author: free.zhang
     * @datetime: 2018年1月13日 下午8:20:30
     * @desc: 初始化workbook, sheet, fields对象，防止多次连续调用发生错误
     */
     ...
     * @throws Exception
     * @author: free.zhang
     * @datetime: 2018年1月13日 下午8:20:38
     * @desc: 写入到文件
     */
    public static void toFile(String columnsJsonArray, List<Map<String, Object>> list, String filePath)
            throws Exception {
    ...
    private static void writeTitles(JsonArray array, int rowIndex, String parentTitle) {
        ...
        if (lastRow != null && parentTitle != null) {
            for (int i = 0; i < currentMaxColumns; i++) {
                if (lastRow.getCell(i) != null && lastRow.getCell(i).getStringCellValue() != null
        ...
        while (it.hasNext()) {
            ...
            // 设置前景色
            cs.setFillForegroundColor(new XSSFColor(
                    new java.awt.Color(RandomUtils.getRandomInt(0, 255), 185, RandomUtils.getRandomInt(0, 255))));
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (i == count - 1) {
                    // 如果有子节点,递归写入子节点
                    if (e.getAsJsonObject().get("children") != null
                            && e.getAsJsonObject().get("children").getAsJsonArray().size() != 0) {
                        writeTitles(e.getAsJsonObject().get("children").getAsJsonArray(), rowIndex + 1,
     ...
     * @return
     * @author: free.zhang
     * @datetime: 2018年1月13日 下午8:21:31
     * @desc: 获取当前节点的子节点数量
     */
    private static int getSubNodesCount(JsonElement e) {
        JsonArray array = e.getAsJsonObject().get("children") == null ? null
                : e.getAsJsonObject().get("children").getAsJsonArray();
        if (array == null)
            return 0;
    ...
    public static void main(String[] args) throws Exception {
        ...
        CustomizeToExcel.toFile(
                "[{\"title\":\"A\",\"field\":\"A\",\"width\":22},{\"title\":\"B\",\"field\":\"B\",\"width\":20,\"children\":[{\"title\":\"C\",\"field\":\"C\",\"width\":30},{\"title\":\"D\",\"field\":\"D\",\"width\":30},{\"title\":\"E\",\"field\":\"E\",\"width\":30,\"children\":[{\"title\":\"X\",\"field\":\"X\",\"width\":22},{\"title\":\"Y\",\"field\":\"Y\",\"width\":22,\"children\":[{\"title\":\"EE\",\"field\":\"EE\",\"width\":22},{\"title\":\"SS\",\"field\":\"SS\",\"width\":22,\"children\":[{\"title\":\"uu\",\"field\":\"uu\",\"width\":22},{\"title\":\"i\",\"field\":\"i\",\"width\":22},{\"title\":\"o\",\"field\":\"o\",\"width\":22}]}]}]}]},{\"title\":\"Z\",\"field\":\"Z\",\"width\":22}]",
                list, "D:\\x1.xlsx");
     ...
     * @throws Exception
     * @author: free.zhang
     * @datetime: 2018年1月13日 下午8:18:08
     * @desc: 将数据导入到Excel并且下载
     */
    public static void downloadXlsx(HttpServletResponse response, List<ExcelColumn> columns,
                                    List<Map<String, Object>> list, String excelName) throws Exception {
        try {
            Workbook workBook = getWorkbook(columns, list);
            response.reset();
            response.setHeader("Content-disposition",
                    "attachment; filename=" + new String(excelName.getBytes("utf-8"), "iso8859-1") + ".xlsx");
     ...
     * @throws Exception
     * @author: free.zhang
     * @datetime: 2018年1月13日 下午8:17:50
     * @desc: 将数据导入到Excel并且下载
     */
    public static void downloadXlsx(HttpServletResponse response, String columnsJsonArray,
                                    List<Map<String, Object>> list, String excelName) throws Exception {
        try {

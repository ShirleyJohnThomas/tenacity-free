package com.tenacity.free.common.email;
 ...
 * @file_name: MailSenderUtils.java
 * @author: free.zhang
 * @datetime: 2018年1月13日 下午8:05:38
 * @desc: 邮件发送
 */
public class MailSenderUtils {
     ...
     */
    public boolean sendTextMail(Email mail) throws GeneralSecurityException, MessagingException {
        // 判断是否需要身份认证
     ...
     * @throws MessagingException
     */
    public boolean sendHtmlMail(Email mail) throws GeneralSecurityException, UnsupportedEncodingException, MessagingException {
        // 判断是否需要身份认证
        MailAuthenticator authenticator = null;
